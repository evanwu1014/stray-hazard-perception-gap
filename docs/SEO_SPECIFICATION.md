...
| :--- | :--- | :--- | :--- |
| **首頁 (`/`)** | 繁體中文 | 純結果論危害指數 — Pure Consequentialist Hazard Index | 排除主觀情感，以科學量化衡量行為造成的真實損害。一套將行為拆解為三個獨立量化指標的純結果論評分機制。 |
| | 簡體中文 | 纯结果论危害指数 — Pure Consequentialist Hazard Index | 排除主观情感，以科学量化衡量行为造成的真实损害。一套将行为拆解为三个独立量化指标的纯结果论评分机制。 |
