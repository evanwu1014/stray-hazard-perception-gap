export const hazardData = {
  ...
  relationship: {
    ...
    beneficiaries: [
      {
        icon: "home",
        category: "獲得家庭安置的子代個體",
        entities: "被出售並進入家庭的純種幼犬貓",
        desc: "成功被銷售並獲得妥善照顧的子代個體，其生命進入了相對穩定的家庭環境，免於繁殖場的後續拘禁。",
        caveat: "此收益以母體在密閉籠具中的終身生育耗損為代價，且每一隻成功出售的子代背後，存在無法計量的母體痛苦與代際遺傳病風險。個體安置的有限改善不能正當化整條繁殖供應鏈的系統性剝削。"
      }
    ]
  }
};