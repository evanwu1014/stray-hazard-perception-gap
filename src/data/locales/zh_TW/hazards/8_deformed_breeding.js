export const hazardData = {
    ...
    detailContent: {
      ...
      causeAnalysis: "繁殖業者採用近親交配固化病理性特徵，如法鬥犬的短吻、茶杯型動物的極端矮小化。這些特徵在市場上獲得溢價，創造了強烈的經濟誘因使業者持續投入。消費端的無知與平台行銷的美化，共同維持了這條傷害鏈。",
    ...
    scenarios: [
      {
        ...
        riskLevel: "critical",
        riskLabel: "極端危害",
        desc: "法鬥、巴哥、英鬥、波斯貓等極端短吻品種，因頭骨結構導致終身呼吸道阻塞（BOAS）。量產環境下母體高難產率（剖腹產率高達 80% 至 90%），子代在生命早期即承受慢性呼吸窘迫。",
        actions: [
  ...
  relationship: {
    agents: [
      {
        role: "以病態特徵為賣點的商業繁育者",
        note: "刻意使用近親交配固化病理性特徵（短吻、矮化、摺耳），因這些特徵在市場上獲得溢價"
      },
      {
        role: "消費端的無知與平台行銷",
        note: "共同維持了「需求 → 供給」的傷害鏈條"
      }
    ],
    transmission: "市場對畸形特徵的溢價 → 近親交配刻意保留病理性狀 → 將痛苦寫入基因編碼並批發製造 → 極高母體難產率（法鬥剖腹產率高達 80% 至 90%）→ 子代出生即帶不可逆的系統性生理障礙 → 高醫療支出 → 棄養率飆升 → 收容系統崩潰",
    victims: [
      {
        icon: "bone",
        category: "畸形遺傳子代（大規模）",
        entities: "法鬥、巴哥、英鬥、波斯貓（BOAS）；茶杯貴賓、迷你馬爾濟斯（極端矮化）；摺耳貓（骨骼病變）",
        desc: "出生即帶有結構性生理障礙，注定承受漫長的病理痛苦。此類別為本指數中「社會輿論譴責最低、客觀危害最高」落差最大的類別。"
      },
      {
        icon: "pregnant",
        category: "繁殖母畜",
        entities: "種母犬貓",
        desc: "被當作「畸變基因」的生產機器。極端短吻品種的母體難產率極高，被反覆剖腹產直至生育能力耗盡。"
      },
      {
        icon: "hospital",
        category: "獸醫資源與棄養安置系統",
        entities: "獸醫體系、收容所",
        desc: "畸變品種的終身醫療費用遠高於一般品種，飼主無力負擔時棄養率顯著高於均值；在收容環境中存活率低、適養媒合困難，形成對獸醫資源與安置系統的結構性消耗。"
      }
    ],
    beneficiaries: [
      {
        icon: "money",
        category: "繁殖業者與寵物產業鏈（商業獲利）",
        entities: "繁殖業者、寵物零售通路、相關醫療服務業",
        desc: "極端畸變品種因稀缺性與社群媒體放大的「可愛效應」，在市場上獲得顯著溢價。繁殖業者、寵物店、以及後端終身醫療需求（BOAS 手術、骨科治療等）共同構成了一條因此獲利的產業鏈。",
        caveat: "此處呈現商業獲利的目的，是揭示「誰在為維持現狀而獲益」——商業利益的高度集中創造了強力的政治游說誘因，使管制難度遠高於其他類型的動物危害。此為本指數中「社會輿論譴責最低、客觀危害最高」落差最大類別之一的核心成因，而非為此獲利提供正當性。"
      }
    ]
  }
};