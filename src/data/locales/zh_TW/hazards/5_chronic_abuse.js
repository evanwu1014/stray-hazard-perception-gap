      ...
      beneficiaries: [
        {
          ...
          entities: "（此樣態在所有維度均為純損害）",
          desc: "在純結果論框架下，長期物理虐待不產生任何可辯護的正向結果。痛苦持續時間的乘數效應使累積危害高於瞬間虐殺，損害完全收斂於受害個體，無任何正向外溢效應。",
          caveat: "施虐者的「控制感」在行為心理學上或有短期主觀緩解，但此屬個人主觀感受，不構成結果論計量框架下的客觀正向結果。"
        }
      ]
    },
    {
      ...
      beneficiaries: [
        {
          icon: "brain",
          category: "囤積者本身（短期心理緩解）",
          entities: "病態囤積行為的執行者",
          desc: "囤積行為在神經科學層面為囤積者提供了短期的焦慮緩解與依附滿足感（催產素機制）。此為推動行為持續的心理驅動力。",
          caveat: "此收益純屬囤積者的「短期主觀心理緩解」，完全不構成對受害動物的任何正向結果。囤積行為對動物群體造成的慢性系統性痛苦（飢餓、傳染病、互食）遠遠超越任何心理緩解的計量值。理解此機制的目的是解釋行為的成因，而非為其正當化。"
        }
      ]
    }
  ]
