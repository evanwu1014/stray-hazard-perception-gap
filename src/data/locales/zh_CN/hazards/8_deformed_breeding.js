    ...
    scenarios: [
      {
        ...
        riskLevel: "critical",
        riskLabel: "极端危害",
        desc: "法斗、巴哥、英斗、波斯猫等极端短吻品种，因头骨结构导致终身呼吸道阻碍（BOAS）。量产环境下母体高难产率（剖腹产率高达 80% 至 90%），子代在生命早期即承受慢性呼吸窘迫。",
        actions: [
...
,
  relationship: {
    ...
    transmission: "市场对畸形特征的溢价 → 近亲交配刻意保留病理性状 → 将痛苦写入基因编码并批发制造 → 极高母体难产率（法斗剖腹产率高达 80% 至 90%） → 子代出生即带不可逆的系统性生理障碍 → 高医疗支出 → 弃养率飙升 → 收容系统崩溃",
    victims: [
      {
        icon: "bone",
        category: "畸形遗传子代（大规模）",
