export const hazardData = {
  ...
  relationship: {
    ...
    beneficiaries: [
      {
        icon: "🏠",
        category: "获得家庭安置的子代个体",
        entities: "被出售并进入家庭的纯种幼犬猫",
        desc: "成功被销售并获得妥善照顾的子代个体，其生命进入了相对稳定的家庭环境，免于繁殖场的后续拘禁。",
        caveat: "此收益以母体在密闭笼具中的终身生育耗损为代价，且每一只成功出售的子代背后，存在无法计量的母体痛苦与代际遗传病风险。个体安置的有限改善不能正当化整条繁殖供应链的系统性剥削。"
      }
    ]
  }
};