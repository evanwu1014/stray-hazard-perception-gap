      ...
      beneficiaries: [
        {
          ...
          caveat: "施虐者的「控制感」在行为心理学上或有短期主观缓解，但此属个人主观感受，不构成结果论计量框架下的客观正向结果。"
        }
      ]
    },
    {
      ...
      beneficiaries: [
        {
          ...
          caveat: "此收益纯属囤积者的「短期主观心理缓解」，完全不构成对受害动物的任何正向结果。囤积行为对动物群体造成的慢性系统性痛苦（饥饿、传染病、互食）远远超越任何心理缓解的计量值。理解此机制的目的是解释成因，而非为其正当化。"
        }
      ]
    }
  ]
